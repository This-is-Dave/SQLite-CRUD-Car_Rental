...
class cost : AppCompatActivity() {
    ...
    private lateinit var sqliteHelper: costSQLiteHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initView()
        initRecycleView()
        sqliteHelper = costSQLiteHelper(this)
    ...
    private fun initView() {
        ...
        recyclerView = findViewById(R.id.recyclerView_cost)
    }
